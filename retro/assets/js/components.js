...
var LOGO = '<img src="assets/img/logo.png" alt="St. Francis School Logo" class="school-logo">';
  ...
  function headerHTML() {
    return [
      ...
      '<a class="nav-link dropdown-toggle' + (["about.html", "patron-saint.html", "management.html", "principal-message.html", "headmistress-message.html"].indexOf(PAGE) > -1 ? " active" : "") + '" href="about.html" role="button" data-bs-toggle="dropdown">About Us</a>',
      ...
      navItem("admissions.html", "Admissions"),
      navItem("facilities.html", "Facilities"),
      navItem("achievements.html", "Achievements"),
      '<li class="nav-item dropdown">',
      '<a class="nav-link dropdown-toggle' + (["notice-board.html", "events.html", "gallery.html", "virtual-tour.html", "contact.html"].indexOf(PAGE) > -1 ? " active" : "") + '" href="notice-board.html" role="button" data-bs-toggle="dropdown">More</a>',
      '<ul class="dropdown-menu">',
      ...
      "</ul></div>",
      '<a class="nav-cta" href="admissions.html"><i class="fa-solid fa-pen-to-square"></i> Admission Open</a>',
      "</div>",
      "</div>",
      "</nav>",
  ...
  function footerHTML() {
    return [
      ...
      "<li><a href='academics.html'>Nursery Wing</a></li>",
      "<li><a href='academics.html'>Primary Wing</a></li>",
      "<li><a href='academics.html'>Secondary Wing</a></li>",
